...
button: { backgroundColor: '#184F78', padding:10,borderRadius: 10 ,top:350,width:162,
  ...
  submitButton: { backgroundColor: '#FEDC62', marginTop:20 }, // Yellow for Submit
  ...
  firstNextButton: { right:-180 }, // Alignement à droite pour la première question
